...
def test12():
    ...
    print(dict1)
def test13():
    str1 = "pk_Id=0&secondName=%E8%BF%91%E6%9D%A5%E5%8F%AF%E5%A5%BD&userName=%E5%A4%A7%E5%B8%88%E5%82%85"
    dict1=dict(
        [k,v[0]] for k,v in parse_qs(str1).items()
    )
    print(dict1)
'''
练习：2025/3/20（1）
...
def test14():
    ...
    print(dict1)#{"'pk_Id'": '0', 'secondName': '近来可好', 'userName': '大师傅'}
    # print(unquote(str1))#'pk_Id'=0&secondName=近来可好&userName=大师傅
    dict2=dict(
        [k,v[0]] for k,v in parse_qs(unquote(str1)).items()
    )
    print(dict2)#{"'pk_Id'": '0', 'secondName': '近来可好', 'userName': '大师傅'}
    dict4=dict(
        [k,v[0]] for k,v in parse_qs(str1).items()
    )
    print(dict4)
