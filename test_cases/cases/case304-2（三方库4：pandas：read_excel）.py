...
def query_excel(file_path, sheet_name='sheet', **conditions):
    """
    查询 Excel 文件中的数据。
    ...
    try:
        # 读取 Excel 文件
        datafile = pd.read_excel(file_path, sheet_name=sheet_name).fillna(method='ffill', axis=0)
        print(datafile)
        # 构建查询条件
...
if __name__ == "__main__":
    file_path = "../../resources/data2.xlsx"
