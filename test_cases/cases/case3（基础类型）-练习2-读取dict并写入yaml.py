...
def test1():
    ...
    for k, v in cookies.items():
        str1 = '{}={}'.format(k, v)
        list1.append(str1)
    print(list1)#['PHPSESSID=htvoegt7rgb27fadl6d22calic', 'SERVERID=7349dbf5589746919266ccf2e3cd1162|1680399216|1680399216', 'ingress_user_id=1680399217.479.24061.806845|d8c6d8cb6c73f72f411c4a27f7a6674a']
    if not os.path.exists('../../resources/token'):
        os.makedirs('../../resources/token')
    with open('../../resources/token/token.yaml', 'w', encoding='utf-8') as f:
        f.write(str(list1))

    # list2 = os.listdir('../resources/token')
    # for i in list2:
    #     str2 = os.path.join('../resources/token', i)
...
def test5():
    ...
    if not os.path.exists('../../resources/token'):
        os.makedirs('../../resources/token')
    with open('../../resources/token/token.yaml','w',encoding='utf-8') as file:
        file.write(str1)
